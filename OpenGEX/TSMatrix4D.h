...
namespace Terathon
{
    ...
    public:
        ...
        template <typename type_struct,
                  ...
                  int index_32,
                  int index_33>
        void operator=(const Submat4D<type_struct,
                                      count,
                                      index_00,
                                      index_01,
                                      index_02,
    ...
    template <typename type_struct,
              ...
              int index_32,
              int index_33>
    inline Bivector3D operator*(const Antivector4D&       v,
    ...
    Vector4D operator*(const Transform3D& m, const Subvec4D<type_struct, false, count, index_x, index_y, index_z, index_w>& v)
    {
        return (Vector4D(m(0, 0) * v.data[index_x] + m(0, 1) * v.data[index_y] + m(0, 2) * v.data[index_z] + m(0, 3) * v.data[index_w],
                         ...
                         m(2, 0) * v.data[index_x] + m(2, 1) * v.data[index_y] + m(2, 2) * v.data[index_z] + m(2, 3) * v.data[index_w], v.data[index_w]));
    }
    ...
    inline Transform3D operator*(const Transform3D&                                                                                                            m1,
                                 const Submat3D<type_struct, count, index_00, index_01, index_02, index_10, index_11, index_12, index_20, index_21, index_22>& m2)
    {
    ...
    template <typename type_struct, int count, int index_00, int index_01, int index_02, int index_10, int index_11, int index_12, int index_20, int index_21, int index_22>
    inline Transform3D operator*(const Submat3D<type_struct, count, index_00, index_01, index_02, index_10, index_11, index_12, index_20, index_21, index_22>& m1,
                                 const Transform3D&                                                                                                            m2)
    {
        Transform3D transform;
