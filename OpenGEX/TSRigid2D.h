...
namespace Terathon
{
    ...
    inline Line2D operator!(const FlatPoint2D& p)
    {
        return (Complement(p));
    }
    inline FlatPoint2D operator!(const Line2D& g)
    {
        return (Complement(g));
    }
    ...
    inline const Line2D& operator~(const Line2D& g)
    {
        return (g);
    }
    ...
    inline Line2D operator^(const FlatPoint2D& p, const FlatPoint2D& q)
    {
        return (Wedge(p, q));
    }
    inline Line2D operator^(const Point2D& p, const Point2D& q)
    {
        return (Wedge(p, q));
    }
    inline Line2D operator^(const Point2D& p, const Vector2D& v)
    {
        return (Wedge(p, v));
    }
    ...
    inline FlatPoint2D operator^(const Line2D& g, const Line2D& h)
    {
        return (Antiwedge(g, h));
    }
    inline float operator^(const Point2D& p, const Line2D& g)
    {
        return (Antiwedge(p, g));
    }
    inline float operator^(const Line2D& g, const Point2D& p)
    {
        return (Antiwedge(g, p));
    }
