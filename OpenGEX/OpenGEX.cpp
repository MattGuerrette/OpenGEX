...
bool MetricStructure::ValidateProperty(const DataDescription* dataDescription, std::string_view identifier, DataType* type, void** value)
{
    if (identifier == "key")
    {
        *type = kDataString;
...
DataResult MetricStructure::ProcessData(DataDescription* dataDescription)
{
    ...
    else if (metricKey == "up")
    {
        ...
        const auto& string = dataStructure->GetDataElement(0);
        if ((string != "z") && (string != "y"))
        {
            return (kDataOpenGexInvalidUpDirection);
        }

        static_cast<OpenGexDataDescription*>(dataDescription)->SetUpDirection(string.c_str());
    }
    else if (metricKey == "forward")
    {
        ...
        static_cast<OpenGexDataDescription*>(dataDescription)->SetForwardDirection(string.c_str());
    }
...
bool MaterialRefStructure::ValidateProperty(const DataDescription* dataDescription, std::string_view identifier, DataType* type, void** value)
{
    if (identifier == "index")
    {
        *type = kDataUInt32;
...
bool MatrixStructure::ValidateProperty(const DataDescription* dataDescription, std::string_view identifier, DataType* type, void** value)
{
...
TranslationStructure::TranslationStructure() : MatrixStructure(kStructureTranslation), translationKind("xyz")
{
}
...
bool TranslationStructure::ValidateProperty(const DataDescription* dataDescription, std::string_view identifier, DataType* type, void** value)
{
    if (identifier == "kind")
    {
        *type = kDataString;
...
RotationStructure::RotationStructure() : MatrixStructure(kStructureRotation), rotationKind("axis")
{
}
...
bool RotationStructure::ValidateProperty(const DataDescription* dataDescription, std::string_view identifier, DataType* type, void** value)
{
    if (identifier == "kind")
    {
        *type = kDataString;
...
ScaleStructure::ScaleStructure() : MatrixStructure(kStructureScale), scaleKind("xyz")
{
}
...
bool ScaleStructure::ValidateProperty(const DataDescription* dataDescription, std::string_view identifier, DataType* type, void** value)
{
    if (identifier == "kind")
    {
        *type = kDataString;
...
bool MorphWeightStructure::ValidateProperty(const DataDescription* dataDescription, std::string_view identifier, DataType* type, void** value)
{
    if (identifier == "index")
    {
        *type = kDataUInt32;
...
bool LightNodeStructure::ValidateProperty(const DataDescription* dataDescription, std::string_view identifier, DataType* type, void** value)
{
    if (identifier == "shadow")
    {
        *type = kDataBool;
...
bool VertexArrayStructure::ValidateProperty(const DataDescription* dataDescription, std::string_view identifier, DataType* type, void** value)
{
    ...
    if (attribString == "position")
    {
        if (arraySize == 3)
        {
            ...
            if ((scale != 1.0F) || (up != 'z'))
            {
                ...
                if (up == 'z')
                {
                    transform.Set(scale, 0.0F, 0.0F, 0.0F, 0.0F, scale, 0.0F, 0.0F, 0.0F, 0.0F, scale, 0.0F);
                }
                else
                {
                    transform.Set(scale, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -scale, 0.0F, 0.0F, scale, 0.0F, 0.0F);
                }
...
{
    StructureType type = structure->GetStructureType();
    if ((type == kStructureTransform) || (type == kStructureSkeleton) || (type == kStructureBoneCountArray) || (type == kStructureBoneIndexArray) ||
        (type == kStructureBoneWeightArray))
    {
        return (true);
    }
...
bool MorphStructure::ValidateProperty(const DataDescription* dataDescription, std::string_view identifier, DataType* type, void** value)
{
    if (identifier == "index")
    {
        *type = kDataUInt32;
...
bool GeometryObjectStructure::ValidateProperty(const DataDescription* dataDescription, std::string_view identifier, DataType* type, void** value)
{
    if (identifier == "visible")
    {
        *type = kDataBool;
...
DataResult GeometryObjectStructure::ProcessData(DataDescription* dataDescription)
{
    ...
    while (structure)
    {
        ...
        if (type == kStructureMesh)
        {
            ...
            auto           it = meshMap.insert({meshStructure->GetKey(), meshStructure});
            if (!it.second)
            {
        ...
        else if (type == kStructureMorph)
        {
            ...
            auto            it = morphMap.insert({morphStructure->GetKey(), morphStructure});
            if (!it.second)
            {
...
bool LightObjectStructure::ValidateProperty(const DataDescription* dataDescription, std::string_view identifier, DataType* type, void** value)
{
    if (identifier == "type")
    {
        *type = kDataString;
...
DataResult LightObjectStructure::ProcessData(DataDescription* dataDescription)
{
    ...
    while (structure)
    {
        ...
        else if (type == kStructureTexture)
        {
            ...
            {
                const auto textureName = textureStructure->GetTextureName();
        ...
        else if (type == kStructureAtten)
        {
            ...
            const auto&           attenKind = attenStructure->GetAttenKind();
            const auto&           curveType = attenStructure->GetCurveType();
...
DataResult CameraObjectStructure::ProcessData(DataDescription* dataDescription)
{
    ...
    while (structure)
    {
        ...
        {
            const ParamStructure* paramStructure = static_cast<const ParamStructure*>(structure);
            const auto&           attribString = paramStructure->GetAttribString();
...
bool AttribStructure::ValidateProperty(const DataDescription* dataDescription, std::string_view identifier, DataType* type, void** value)
{
    if (identifier == "attrib")
    {
        *type = kDataString;
...
bool SpectrumStructure::ValidateProperty(const DataDescription* dataDescription, std::string_view identifier, DataType* type, void** value)
{
...
bool TextureStructure::ValidateProperty(const DataDescription* dataDescription, std::string_view identifier, DataType* type, void** value)
{
...
AttenStructure::AttenStructure() : OpenGexStructure(kStructureAtten), attenKind("distance"), curveType("linear")
{
    beginParam = 0.0F;
    endParam = 1.0F;
...
bool AttenStructure::ValidateProperty(const DataDescription* dataDescription, std::string_view identifier, DataType* type, void** value)
{
    if (identifier == "kind")
    {
        *type = kDataString;
...
bool MaterialStructure::ValidateProperty(const DataDescription* dataDescription, std::string_view identifier, DataType* type, void** value)
{
...
KeyStructure::KeyStructure() : OpenGexStructure(kStructureKey), keyKind("value")
{
}
...
bool KeyStructure::ValidateProperty(const DataDescription* dataDescription, std::string_view identifier, DataType* type, void** value)
{
    if (identifier == "kind")
    {
        *type = kDataString;
...
CurveStructure::CurveStructure(StructureType type) : OpenGexStructure(type), curveType("linear")
{
...
bool CurveStructure::ValidateProperty(const DataDescription* dataDescription, std::string_view identifier, DataType* type, void** value)
{
    if (identifier == "curve")
    {
        *type = kDataString;
...
DataResult CurveStructure::ProcessData(DataDescription* dataDescription)
{
    ...
    while (structure)
    {
        if (structure->GetStructureType() == kStructureKey)
        {
            ...
            const auto&         keyKind = keyStructure->GetKeyKind();
...
DataResult TimeStructure::ProcessData(DataDescription* dataDescription)
{
    ...
    const auto& curveType = GetCurveType();
...
bool TrackStructure::ValidateProperty(const DataDescription* dataDescription, std::string_view identifier, DataType* type, void** value)
{
...
bool ClipStructure::ValidateProperty(const DataDescription* dataDescription, std::string_view identifier, DataType* type, void** value)
{
    if (identifier == "index")
    {
        *type = kDataUInt32;
...
void OpenGexDataDescription::AdjustTransform(Transform3D& transform) const
{
    ...
    if (upDirection[0] == 'y')
    {
        transform.Set(transform(0, 0), -transform(0, 2), transform(0, 1), transform(0, 3), -transform(2, 0), transform(2, 2), -transform(2, 1), -transform(2, 3), transform(1, 0),
                      -transform(1, 2), transform(1, 1), transform(1, 3));
    }
}
