...
namespace Terathon
{
    ...
    template <typename A_type_struct,
              ...
              int  B_index_y,
              int  B_index_z>
    inline bool operator==(const Subvec3D<A_type_struct, A_anti, A_count, A_index_x, A_index_y, A_index_z>& A,
                           const Subvec3D<B_type_struct, B_anti, B_count, B_index_x, B_index_y, B_index_z>& B)
    {
    ...
    template <typename A_type_struct,
              ...
              int  B_index_z,
              int  B_index_w>
    inline bool operator==(const Subvec4D<A_type_struct, A_anti, A_count, A_index_x, A_index_y, A_index_z, A_index_w>& A,
                           const Subvec4D<B_type_struct, B_anti, B_count, B_index_x, B_index_y, B_index_z, B_index_w>& B)
    {
        return ((A.data[A_index_x] == B.data[B_index_x]) && (A.data[A_index_y] == B.data[B_index_y]) && (A.data[A_index_z] == B.data[B_index_z]) &&
    ...
    template <typename type_struct>
    using Antivec3D = Vec3D<type_struct, true>;
    template <typename type_struct>
    using Antivec4D = Vec4D<type_struct, true>;
    ...
    template <typename A_type_struct,
              ...
              int B_index_y,
              int B_index_z>
    inline float operator^(const Subvec3D<A_type_struct, A_anti, A_count, A_index_x, A_index_y, A_index_z>&  A,
                           const Subvec3D<B_type_struct, !A_anti, B_count, B_index_x, B_index_y, B_index_z>& B)
    {
        return (A.data[A_index_x] * B.data[B_index_x] + A.data[A_index_y] * B.data[B_index_y] + A.data[A_index_z] * B.data[B_index_z]);
    }
    ...
    template <typename A_type_struct,
              ...
              int B_index_z,
              int B_index_w>
    inline float operator^(const Subvec4D<A_type_struct, false, A_count, A_index_x, A_index_y, A_index_z, A_index_w>& A,
                           const Subvec4D<B_type_struct, true, B_count, B_index_x, B_index_y, B_index_z, B_index_w>&  B)
    {
    ...
    template <typename A_type_struct,
              ...
              int B_index_z>
    inline float operator^(const Subvec4D<A_type_struct, false, A_count, A_index_x, A_index_y, A_index_z, A_index_w>& A,
                           const Subvec3D<B_type_struct, true, B_count, B_index_x, B_index_y, B_index_z>&             B)
    {
        return (A.data[A_index_x] * B.data[B_index_x] + A.data[A_index_y] * B.data[B_index_y] + A.data[A_index_z] * B.data[B_index_z]);
    }
    ...
    template <typename A_type_struct,
              ...
              int B_index_z,
              int B_index_w>
    inline float operator^(const Subvec3D<A_type_struct, false, A_count, A_index_x, A_index_y, A_index_z>&           A,
                           const Subvec4D<B_type_struct, true, B_count, B_index_x, B_index_y, B_index_z, B_index_w>& B)
    {
        return (A.data[A_index_x] * B.data[B_index_x] + A.data[A_index_y] * B.data[B_index_y] + A.data[A_index_z] * B.data[B_index_z]);
    }
    ...
    template <typename A_type_struct,
              ...
              int B_index_10,
              int B_index_11>
    inline bool operator==(const Submat2D<A_type_struct, A_count, A_index_00, A_index_01, A_index_10, A_index_11>& A,
                           const Submat2D<B_type_struct, B_count, B_index_00, B_index_01, B_index_10, B_index_11>& B)
    {
        return ((A.data[A_index_00] == B.data[B_index_00]) && (A.data[A_index_01] == B.data[B_index_01]) && (A.data[A_index_10] == B.data[B_index_10]) &&
    ...
    struct ConverterMatrix3D
    {
        ...
        {
            return (const_matrix3D_type(data[index_00], data[index_01], data[index_02], data[index_10], data[index_11], data[index_12], data[index_20], data[index_21],
                                        data[index_22]));
        }
    };
    ...
    public:
        ...
        void Set(const component_type& m00,
                 const component_type& m01,
                 const component_type& m02,
                 const component_type& m10,
                 const component_type& m11,
                 ...
                 const component_type& m20,
                 const component_type& m21,
                 const component_type& m22) volatile
        {
            data[index_00] = m00;
            data[index_10] = m10;
            data[index_20] = m20;
    ...
    template <typename A_type_struct,
              ...
              int B_index_21,
              int B_index_22>
    inline bool operator==(const Submat3D<A_type_struct, A_count, A_index_00, A_index_01, A_index_02, A_index_10, A_index_11, A_index_12, A_index_20, A_index_21, A_index_22>& A,
                           const Submat3D<B_type_struct, B_count, B_index_00, B_index_01, B_index_02, B_index_10, B_index_11, B_index_12, B_index_20, B_index_21, B_index_22>& B)
    {
        return ((A.data[A_index_00] == B.data[B_index_00]) && (A.data[A_index_01] == B.data[B_index_01]) && (A.data[A_index_02] == B.data[B_index_02]) &&
                (A.data[A_index_10] == B.data[B_index_10]) && (A.data[A_index_11] == B.data[B_index_11]) && (A.data[A_index_12] == B.data[B_index_12]) &&
                (A.data[A_index_20] == B.data[B_index_20]) && (A.data[A_index_21] == B.data[B_index_21]) && (A.data[A_index_22] == B.data[B_index_22]));
    }
    ...
    struct ConverterMatrix4D
    {
        ...
        {
            return (matrix4D_type(data[index_00], data[index_01], data[index_02], data[index_03], data[index_10], data[index_11], data[index_12], data[index_13], data[index_20],
                                  data[index_21], data[index_22], data[index_23], data[index_30], data[index_31], data[index_32], data[index_33]));
        }

        static const_matrix4D_type Convert(const component_type* data)
        {
            return (const_matrix4D_type(data[index_00], data[index_01], data[index_02], data[index_03], data[index_10], data[index_11], data[index_12], data[index_13],
                                        data[index_20], data[index_21], data[index_22], data[index_23], data[index_30], data[index_31], data[index_32], data[index_33]));
        }
    };
    ...
    public:
        ...
        void Set(const component_type& m00,
                 ...
                 const component_type& m31,
                 const component_type& m32,
                 const component_type& m33) volatile
        {
            data[index_00] = m00;
            data[index_10] = m10;
            data[index_20] = m20;
        ...
        {
            return (ConverterMatrix4D<type_struct, index_00, index_01, index_02, index_03, index_10, index_11, index_12, index_13, index_20, index_21, index_22, index_23, index_30,
                                      index_31, index_32, index_33>::Convert(data));
        }
        ...
        operator typename ConverterMatrix4D<type_struct,
                                            ...
                                            index_31,
                                            index_32,
                                            index_33>::const_matrix4D_type(void) const
        {
            return (ConverterMatrix4D<type_struct, index_00, index_01, index_02, index_03, index_10, index_11, index_12, index_13, index_20, index_21, index_22, index_23, index_30,
                                      index_31, index_32, index_33>::Convert(data));
        }
        ...
        template <typename type,
                  ...
                  int ind_33>
        Submat4D& operator=(
            const Submat4D<type, cnt, ind_00, ind_01, ind_02, ind_03, ind_10, ind_11, ind_12, ind_13, ind_20, ind_21, ind_22, ind_23, ind_30, ind_31, ind_32, ind_33>& value)
        {
            data[index_00] = value.data[ind_00];
            data[index_10] = value.data[ind_10];
            data[index_20] = value.data[ind_20];
        ...
        template <typename type,
                  ...
                  int ind_32,
                  int ind_33>
        void operator=(const Submat4D<type, cnt, ind_00, ind_01, ind_02, ind_03, ind_10, ind_11, ind_12, ind_13, ind_20, ind_21, ind_22, ind_23, ind_30, ind_31, ind_32, ind_33>&
                           value) volatile
        {
            data[index_00] = value.data[ind_00];
            data[index_10] = value.data[ind_10];
    ...
    {
        return ((A.data[A_index_00] == B.data[B_index_00]) && (A.data[A_index_01] == B.data[B_index_01]) && (A.data[A_index_02] == B.data[B_index_02]) &&
                (A.data[A_index_03] == B.data[B_index_03]) && (A.data[A_index_10] == B.data[B_index_10]) && (A.data[A_index_11] == B.data[B_index_11]) &&
                (A.data[A_index_12] == B.data[B_index_12]) && (A.data[A_index_13] == B.data[B_index_13]) && (A.data[A_index_20] == B.data[B_index_20]) &&
                (A.data[A_index_21] == B.data[B_index_21]) && (A.data[A_index_22] == B.data[B_index_22]) && (A.data[A_index_23] == B.data[B_index_23]) &&
                (A.data[A_index_30] == B.data[B_index_30]) && (A.data[A_index_31] == B.data[B_index_31]) && (A.data[A_index_32] == B.data[B_index_32]) &&
    ...
    public:
        ...
        template <typename type,
                  ...
                  int ind_33>
        Mat4D& operator=(
            const Submat4D<type, cnt, ind_00, ind_01, ind_02, ind_03, ind_10, ind_11, ind_12, ind_13, ind_20, ind_21, ind_22, ind_23, ind_30, ind_31, ind_32, ind_33>& m)
        {
            matrix = m;
            return (*this);
        }
        ...
        template <typename type,
                  ...
                  int ind_33>
        void operator=(
            const Submat4D<type, cnt, ind_00, ind_01, ind_02, ind_03, ind_10, ind_11, ind_12, ind_13, ind_20, ind_21, ind_22, ind_23, ind_30, ind_31, ind_32, ind_33>& m) volatile
        {
            matrix = m;
        }
    };
    ...
    template <typename m_type_struct,
              ...
              int v_index_y,
              int v_index_z>
    inline typename v_type_struct::vector3D_type operator*(
    ...
    template <typename v_type_struct,
              ...
              int m_index_22>
    inline typename v_type_struct::vector3D_type operator*(
        const Subvec3D<v_type_struct, true, v_count, v_index_x, v_index_y, v_index_z>&                                                                      v,
        const Submat3D<m_type_struct, m_count, m_index_00, m_index_01, m_index_02, m_index_10, m_index_11, m_index_12, m_index_20, m_index_21, m_index_22>& m)
    {
    ...
    template <typename A_type_struct,
              ...
              int B_index_21,
              int B_index_22>
    TERATHON_API typename A_type_struct::matrix3D_type operator*(
        const Submat3D<A_type_struct, A_count, A_index_00, A_index_01, A_index_02, A_index_10, A_index_11, A_index_12, A_index_20, A_index_21, A_index_22>& A,
        const Submat3D<B_type_struct, B_count, B_index_00, B_index_01, B_index_02, B_index_10, B_index_11, B_index_12, B_index_20, B_index_21, B_index_22>& B);
    ...
    template <typename m_type_struct,
              ...
              int v_index_z,
              int v_index_w>
    inline typename v_type_struct::vector4D_type operator*(const Submat4D<m_type_struct,
                                                                          m_count,
                                                                          m_index_00,
                                                                          m_index_01,
                                                                          m_index_02,
                                                           ...
                                                           const Subvec4D<v_type_struct, false, v_count, v_index_x, v_index_y, v_index_z, v_index_w>& v)
    {
        return (typename v_type_struct::vector4D_type(
            m.data[m_index_00] * v.data[v_index_x] + m.data[m_index_01] * v.data[v_index_y] + m.data[m_index_02] * v.data[v_index_z] + m.data[m_index_03] * v.data[v_index_w],
    ...
    {
        return (typename v_type_struct::vector4D_type(
            m.data[m_index_00] * v.data[v_index_x] + m.data[m_index_10] * v.data[v_index_y] + m.data[m_index_20] * v.data[v_index_z] + m.data[m_index_30] * v.data[v_index_w],
    ...
    template <typename A_type_struct,
              ...
              int B_index_32,
              int B_index_33>
    TERATHON_API typename A_type_struct::matrix4D_type operator*(const Submat4D<A_type_struct,
                                                                                A_count,
                                                                                A_index_00,
                                                                                A_index_01,
                                                                                A_index_02,
